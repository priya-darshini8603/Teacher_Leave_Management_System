                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblteachers.FirstName,tblteachers.LastName,tblteachers.teacherid,tblteachers.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblteachers on tblleaves.teacherid=tblteachers.id order by lid desc";
